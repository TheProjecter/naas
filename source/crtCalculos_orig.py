...
# ler calibraï¿½ï¿½o arquivo .cal  
#        if self.lerCalibracao(): 
#            print "erro: Leitura de Calibraï¿½ï¿½o"
#            msg = qt.QMessageBox(self)
#            msg.setIcon(qt.QMessageBox.Critical)
#            msg.setText("Ler calibraï¿½ï¿½o antes de processar!")
#            msg.exec_loop()
#            return
...
# lt ï¿½ o tempo vivo 
        #        self.Lt = 180000.0/50
#quando da leitura do arquivo lï¿½ o tempo Vivo e Morto
#       self.Lt = 7200
#        self.Lt = 3597.633136
#        if calon <> 2: 
...
#        print vlegend
        self.Vispectdic={}
        self.vinfo = vlegend
# recupera dados de calibraï¿½ï¿½o
...
#        file=open("c:param.txt",'w')
 ...
 #       file=0       
        #print contenuailes
        #print contenucentre
#Correlator da iniciaï¿½ï¿½o para optimize a velocidade
#'do cï¿½lculo do spectrum (correlates reduzidos do Nb. raizes dos cross-sections)        
...
#                    for il in range(self.Id,self.Fi):
        ...
        self.f1zdeb = 0
        self.f1zfin = 0
#Formar ondas- o controle para determinar as mï¿½scaras pequenas dos picos pelos picos grandes        
#silvio mostra valores de canais para entendimento
 #       file.close
 #       file=0       
...
# a funï¿½ï¿½o tem 4 aï¿½ï¿½es depende do nfoco:
...
# verifica regiï¿½es e calcula area 
...
#    Tratamento de picos simples 
        ...
        #silvio coloquei if caso zero isso quando inicio ideb de 0 e nï¿½o 40 
        if self.Aire == 0: 
            self.Erreur=0.0
            self.Resol=0.0
            self.Absi=0
...
#            for J in range(1,Np):
    ...
    #            print 'Dif1=%f Dif2=%f Dif3=%f Jtest=%d' %(Dif1,Dif2,Dif3,Jtest)    
            ...
            #print It
            if It == 10 :
                #silvio coloquei para forï¿½ar entrar na proxima condiï¿½ï¿½o 
                #Sortie = 0
                break
...
#'        Procedure d'invertion de matrice
    def InvMd(self,N,A):
        #cria matriz con n elemento, mais um espaï¿½o de n lelementos para preencher 
...
#preenche com zeros o segundo espaï¿½o da matriz AB
        for I in range(1,N):
            for J in range(Id,Fi):
                AB[I,J] = 0.0
#        for I in range(1,N):
