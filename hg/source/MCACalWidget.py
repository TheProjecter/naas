# -*- coding: utf-8 -*-
# code originnaly written by V.A. Sole - ESRF BLISS Group - PyMCA program
# adapted by Mario O. de Menezes for SAANI - IPEN-CNEN/SP
...
class McaCalWidget(qt.QDialog):
    def __init__(self, parent=None, name="SAANI Calibration Widget",
                x = None,y=None,current=None,peaks=None,caldict=None,
                specfit=None,legend="", lambda_="-", modal=0,fl=0):
        ...
        if QTVERSION < '4.0.0':
            ...
            self.setModal(modal)
            self.setWindowIcon(qt.QIcon(qt.QPixmap(IconDict['peaksearch'])))
